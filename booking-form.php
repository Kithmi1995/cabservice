                   ...
                   <form name="book" action="booking-form.php" method="post">
                        <table align="center" >
                          ...
                          <tr>
                           ...
                           <tr>
                              <td ><input type="email" name="email" size="100" placeholder="Enter your email address" required></td>
                          </tr>
                          ...
                          <tr>
                           ...
                           <tr>
                              <td><input type="text" name="contact_no" size="100" placeholder="Enter phone number" required></td>
                          </tr>
                           ...
                           <tr>
                              <td><input type="text" name="pickup_loc" size="100" placeholder="Enter pickup location" required></td>
                          </tr>
                           ...
                           <tr>
                              <td><input type="text" name="drop_loc" size="100" placeholder="Enter drop off location" required></td>
                           </tr>
                          ...
                          <tr>
                           ...
                           <tr>
                              <td>
                                <textarea name="message" rows=“5” cols=“60” placeholder="Enter your message" ></textarea>
                              </td>
                           </tr>
