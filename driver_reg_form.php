    ...
    <body  class="reg_body">
        <div>
           ...
           <center> <table align="center" width="100%">
               ...
               <tr>
                  <td><input type="text" name="driver_name" placeholder="Type your name"></td>
                </tr>
               ...
               <tr>
                   <td ><input type="text" name="contact_number" placeholder="Type your contact number"></td>
                </tr>
                ...
                <tr>
                  <td><input type="text" name="nic" placeholder="Type your NIC number"></td>
              </tr>
                ...
                <tr>
                  <td><input type="text" name="license_no" placeholder="Enter License No."></td>
                </tr>
                ...
                <tr>
                    <td class="data5">Username</td>
                       ...
                       <tr>
                          <td><input type="text" name="user_name" placeholder="Insert username"></td>
                       </tr>
                      ...
                      <tr>
                          <center><td><input type="password" name="pwd" placeholder="Enter a password"></td></center>
                      </tr>
                    ...
                    <tr>
                      ...
                      <tr>
                         <center><td><input type="password" name="cpwd" placeholder="Re-enter password"></td></center>
                      </tr><br><br>
